...
export default function SignUp() {
  ...
  async function onSubmit(data: UserFormValues): Promise<void> {
    try {
      ...
      const message = error instanceof ApiError ? error.message : 'Unable to create your account. Please try again.';
  ...
  return (
    <div className='relative flex h-screen w-full items-center justify-between'>
      ...
      <div className='hidden h-full w-full md:w-[50%] lg:flex lg:flex-col lg:items-center lg:justify-center'>
        <div
          className={`${racingsSans.className} text-6xl text-white`}
        >
          Welcome to My Flow
        </div>
      </div>
        ...
        <div className='container__form flex h-full w-full items-center justify-center rounded-xl bg-white p-6 text-slate-800'>
          <div className='max:h-120 max:w-104 lg:my-auto lg:w-104'>
            ...
            <div className='flex items-center lg:hidden'>
              <div className={`${racingsSans.className} text-[1.35rem] md:text-5xl`}>
                Welcome to My Flow
              </div>
            </div>
            ...
            >
              ...
              <div className='my-9 flex flex-col items-start justify-center gap-4'>
                <div className='flex w-full items-center justify-start gap-3 px-1'>
                  <Checkbox label='tnc-check'>
                    <div>
                      I agree to the{' '}
                      <Link
                        href='#'
